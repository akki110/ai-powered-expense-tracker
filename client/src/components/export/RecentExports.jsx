      ...
      <Table>
        <TableHeader className="bg-zinc-50 dark:bg-zinc-900/50">
          <TableRow className="hover:bg-transparent">
            <TableHead className="text-zinc-500 dark:text-zinc-400 font-bold tracking-widest uppercase text-[10px] pl-6">
              Report Name
            </TableHead>
            <TableHead className="text-zinc-500 dark:text-zinc-400 font-bold tracking-widest uppercase text-[10px]">
              Date Generated
            </TableHead>
            <TableHead className="text-zinc-500 dark:text-zinc-400 font-bold tracking-widest uppercase text-[10px]">
              File Size
            </TableHead>
            <TableHead className="text-right text-zinc-500 dark:text-zinc-400 font-bold tracking-widest uppercase text-[10px] pr-6">
              Action
            </TableHead>
          </TableRow>
        </TableHeader>
                  ...
                  <div className="flex items-center justify-end gap-2">
                    ...
                    >
                      <Button
                        variant="ghost"
                        size="icon"
                        className="h-8 w-8 text-zinc-500 hover:text-black dark:hover:text-white rounded-sm"
                      >
